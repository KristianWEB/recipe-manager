      ...
      <section class="flex-1 bg-gray-100 px-3 py-6">
        ...
        <div class="flex flex-col items-center mt-24">
          ...
          <div class="w-1/2 flex border-bottom-1 mb-12">
            <span class="inline-block mr-auto text-3xl mb-3">hui@hui.com</span>
            <i class="material-icons inline-block icon-size-3">edit</i>
          </div>

          <div class="w-1/2 mb-5 font-bold text-xl">Your current password:</div>
          <div class="w-1/2 flex border-bottom-1">
            <span class="inline-block mr-auto text-3xl mb-3">******************</span>
            <i class="material-icons inline-block icon-size-3">edit</i>
          </div>
        </div>
        ...
        <div class="w-full mt-24 text-center">
          <a
            href="http://recipemanager.test/storage"
            class="px-6 py-6 bg-blue-btn-1 rounded-full text-white text-xl"
          >See your saved recipes</a>
        </div>
      </section>
    </main>
  </div>
